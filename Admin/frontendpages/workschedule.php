...
<div class="bg-gray-100 dark:bg-gray-800 transition-colors duration-300">
    <div class="container mx-auto p-4">
        <div class="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
            <h1 class="text-xl font-semibold mb-4 text-sm">Work Schedule</h1>
            ...
            <div class="mb-4">
              ...
              ?>
                ...
                <div class="mb-4">
                    <input type="text" placeholder="workassign" name="workassign" class="border p-2 rounded w-full"><br>
                    <input type="hidden" name="workschedule">
                </div>
                <div class="mb-4">
                    <input type="text" placeholder="givenhours" class="border p-2 rounded w-full" name="givenhours">
                </div>
             
                <div class="mb-4">
                    <input type="text" placeholder="takenhours" name="takenhours" class="border p-2 rounded w-full">
                </div>
                <div class="mb-4">
